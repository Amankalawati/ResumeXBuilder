  ...
  return (
    <>
      ...
      border border-white/10'>
        <div className=' absolute inset-0 bg-gradient-to-r from-violet-500/20 to-fuschia-500/20 animate-pulse'/>
        {/*MAIN PROGRESS BAR */}
        <div className=' relative h-full bg-gradient-to-r from-violet-500 via-fuchsia-500 to-violet-600
        animate-flow bg-[lenth:200%_100%] transition-all duration-700 ease-out rounded-full overflow-hidden
        ...
        {progress > 0 && (
          <div className=' absolute top-0 h-full w-8 bg-gradient-to-r from-transparent via-white/60
      ...
      <div className=' flex justify-between items-center mt-3'> 
        ...
        <div className=' flex items-center gap-2'>
          {progress === 100 && (
            <div className=' w-6 h-6 from-green-500 to-emerald-500 rounded-full 
