...
const CreateResumeForm = () => {
  ...
  return (
    <div className='w-full max-w-md p-8 bg-white rounded-2xl border border-gray-100 shadow-lg'>
      <h3 className=' text-2xl font-bold text-gray-950 mb-2'>Create new resume</h3>
      <p className='text-gray-600 mb-8'>
        Give a title for your resume. You can customize everything later.
      </p>
      <form onSubmit={handleCreateResume}>
         <Input value={title} onChange={({target}) => setTitle(target.value)} label='Resume Title'
            placeholder='eg. Aman k. - Software Engineer' type='text'/>
