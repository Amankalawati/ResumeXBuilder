...
//RESUME SUMMARY CARDS COMPONENT
...
//creating after creating ThemeSelector.jsx
//TEMPLTES CARDS
export const TemplateCard = ({thumbnailImg, isSelected, onSelect}) => {
  return(
    <div className={ `group has-auto md:h-[300px] lg:h-[300px] flex flex-col bg-white border-2 
    overflow-hidden cursor-pointer transitoin-all duration-500 hover:scale-105 hover:shadow-lg rounded-3xl
  ${isSelected ? 'border-violet-500 shadow-lg shadow-violet-500/20 bg-violet-50'
    ...
    { thumbnailImg ? (
        <div className="relative w-full h-full overflow-hidden">
            ...
            <div className=" absolute inset-0 bg-gradient-to-t from-white/00 via-transparent to-transparent
      ...
      <div className=" w-full h-[200px] flex-col justify-center bg-gradient-to-br from-violet-50
