...
const ThemeSelector = ({ selectedTheme, setSelectedTheme, resumeData, onClose}) => {
    ...
    //SELECTING THEMETEMPLATE USING THE ID..
  ...
  return (
    <div className='max-w-7xl mx-auto px-4'>
        ...
        p-4 sm:p-6 bg-gradient-to-r from-white to-violet-50 round-2xl border border-violet-100'>
            
            <Tabs tabs={TAB_DATA} activeTab={tabValue} setActiveTab={setTabValue} />

            <button className='w-full sm:w-auto flex items-center justify-centre gap-3 px-6 py-3 
        ...
        <div className=' grid grid-cols-1 lg:grid-cols-5 gap-6 lg:gap-8'>
            ...
            {/* RIGHT AREA */}
            <div className=' lg:col-span-3 bg-white rounded-2xl border border-gray-100 p4 sm:p-6' ref={resumeRef} >
