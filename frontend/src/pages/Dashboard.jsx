...
const Dashboard = () => {
  ...
  /**IT WILL SHOW COMPLETION PERCENTAGE OR HOW MUCH FILLED THEN IT WILL DO ++ */
  ...
  const fetchAllResumes = async () => {
    ...
    try {
      ...
      //ADD COMPLETION PERACENTAGE TO EACH RESUMES
    ...
    <div>
          ...
          <div>
            ...
            <p className={styles.headerSubtitle}>
              {allResumes.length > 0
                ...
                : "Lets start building your professional resume"}
            </p>
          </div>
      ...
      {!loading && allResumes.length === 0 && (
        <div className={styles.emptyStateWrapper}>
          ...
          <h3 className={styles.emptyTitle}>No Resume Created Yet</h3>
      ...
      {!loading && allResumes.length > 0 && (
        <div className={styles.grid}>
          ...
          <div className={styles.newResumeCard} onClick={() => setOpenCreateModal(true)}>
            ...
            <p className={styles.newResumeText}>Start creating new resume here!</p>
          </div>
      ...
      <div className="p-4">
        <div className="flex flex-col items-center text-center">
          ...
          <p className={styles.deleteText}>
            Are you sure you want to delete your resume? This action can't be undone.
          </p>
        </div>
      </div>
    </Modal>
